...
def analyze_fastq(infile):
    len_counts = [0 for i in range(500000)]
    max_len = 0
...
def analyze_cliques():
    clique_size_counts = [0 for i in range(10000)]
    max_size = 0
...
def analyze_overlaps(filename):
    pp_count = [0 for i in range(4)]
    ps_count = [0 for i in range(4)]
    sp_count = [0 for i in range(4)]
    ss_count = [0 for i in range(4)]
    c = 0
